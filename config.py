...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002429374005"))
...
SHORTLINK_API = os.environ.get("SHORTLINK_API", "fe67ff1cf60abe925f61646a8f78af37dcad192e")
...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002157069008"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002238103479"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "7146923206").split()):
        ADMINS.append(int(x))
except ValueError:
